...
While holding the staff , you can take a [Magic](actions.md#Magic) action and expend 1 charge to cause a swarm of harmless flying insects to fill a 30-foot <span title="Player's Handbook (2024)">Emanation</span> originating from you. The insects remain for 10 minutes, making the area [Heavily Obscured](heavily-obscured-xphb.md) for creatures other than you. A strong wind (like that created by [Gust of Wind](gust-of-wind-xphb.md)) disperses the swarm and ends the effect.
