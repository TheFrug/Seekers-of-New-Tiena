...
While you hold the drawn weapon, it creates a 10-foot <span title="Player's Handbook (2024)">Emanation</span> originating from you. You and all creatures [Friendly](friendly-attitude-xphb.md) to you in the <span title="Player's Handbook (2024)">Emanation</span> have [Advantage](advantage-xphb.md) on saving throws against spells and other magical effects. If you have 17 or more levels in the Paladin class, the size of the <span title="Player's Handbook (2024)">Emanation</span> increases to 30 feet.
