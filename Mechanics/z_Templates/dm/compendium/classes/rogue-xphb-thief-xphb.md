...
If you have the [Hide](actions.md#Hide) action's [Invisible](conditions.md#Invisible) condition, this attack doesn't end that condition on you if you end the turn behind [Three-Quarters Cover](Mechanics/z_Templates/dm/rules/variant-rules/cover-xphb.md) or [Total Cover](Mechanics/z_Templates/dm/rules/variant-rules/cover-xphb.md).
