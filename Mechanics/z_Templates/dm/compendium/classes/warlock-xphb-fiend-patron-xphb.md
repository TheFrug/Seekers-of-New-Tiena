...
Choose one damage type, other than Force, whenever you finish a [Short](short-rest-xphb.md) or [Long Rest](long-rest-xphb.md). You have [Resistance](Mechanics/z_Templates/dm/rules/variant-rules/resistance-xphb.md) to that damage type until you choose a different one with this feature.
