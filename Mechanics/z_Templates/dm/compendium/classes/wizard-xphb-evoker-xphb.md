...
The first time you do so, you suffer no adverse effect. If you use this feature again before you finish a [Long Rest](long-rest-xphb.md), you take `2d12` Necrotic damage for each level of the spell slot immediately after you cast it. This damage ignores [Resistance](Mechanics/z_Templates/dm/rules/variant-rules/resistance-xphb.md) and [Immunity](immunity-xphb.md).
