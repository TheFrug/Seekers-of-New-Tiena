...
Once within the next hour when the creature fails a [D20 Test](rules/variant-rules/d20-test-xphb.md), the creature can roll the Bardic Inspiration die and add the number rolled to the `d20`, potentially turning the failure into a success. A Bardic Inspiration die is expended when it's rolled.
...
You can add half your [Proficiency Bonus](rules/variant-rules/proficiency-xphb.md) (round down) to any ability check you make that uses a skill proficiency you lack and that doesn't otherwise use your [Proficiency Bonus](rules/variant-rules/proficiency-xphb.md).

For example, if you make a Strength ([Athletics](rules/skills.md#Athletics)) check and lack [Athletics](rules/skills.md#Athletics) proficiency, you can add half your [Proficiency Bonus](rules/variant-rules/proficiency-xphb.md) to the check.
...
You now regain all your expended uses of Bardic Inspiration when you finish a [Short](rules/variant-rules/short-rest-xphb.md) or [Long Rest](rules/variant-rules/long-rest-xphb.md).
