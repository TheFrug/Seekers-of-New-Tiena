...
When you reduce an enemy to 0 [Hit Points](rules/variant-rules/hit-points-xphb.md), you gain [Temporary Hit Points](rules/variant-rules/temporary-hit-points-xphb.md) equal to your Charisma modifier plus your Warlock level (minimum of 1 [Temporary Hit Point](rules/variant-rules/temporary-hit-points-xphb.md)). You also gain this benefit if someone else reduces an enemy within 10 feet of you to 0 [Hit Points](rules/variant-rules/hit-points-xphb.md).
...
Choose one damage type, other than Force, whenever you finish a [Short](rules/variant-rules/short-rest-xphb.md) or [Long Rest](rules/variant-rules/long-rest-xphb.md). You have [Resistance](rules/variant-rules/resistance-xphb.md) to that damage type until you choose a different one with this feature.

### Hurl Through Hell (Level 14)

Once per turn when you hit a creature with an attack roll, you can try to instantly transport the target through the Lower Planes. The target must succeed on a Charisma saving throw against your spell save DC, or the target disappears and hurtles through a nightmare landscape. The target takes `8d10` Psychic damage if it isn't a Fiend, and it has the [Incapacitated](rules/conditions.md#Incapacitated) condition until the end of your next turn, when it returns to the space it previously occupied or the nearest unoccupied space.
