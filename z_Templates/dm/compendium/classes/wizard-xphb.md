...
**Starting Equipment:** *Choose A or B:* (A) 2 [Daggers](compendium/items/dagger-xphb.md), Arcane Focus ([Quarterstaff](compendium/items/quarterstaff-xphb.md)), [Robe](compendium/items/robe-xphb.md), Spellbook, [Scholar's Pack](compendium/items/scholars-pack-xphb.md), and 5 GP; or (B) 55 GP
...
You can use an Arcane Focus or your spellbook as a [Spellcasting Focus](rules/variant-rules/spellcasting-focus-xphb.md) for your Wizard spells.
...
Choose two level 3 spells in your spellbook as your signature spells. You always have these spells prepared, and you can cast each of them once at level 3 without expending a spell slot. When you do so, you can't cast them in this way again until you finish a [Short](rules/variant-rules/short-rest-xphb.md) or [Long Rest](rules/variant-rules/long-rest-xphb.md). To cast either spell at a higher level, you must expend a spell slot.