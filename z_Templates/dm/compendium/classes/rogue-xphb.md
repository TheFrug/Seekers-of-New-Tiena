...
Your training with weapons allows you to use the <span title="Player's Handbook (2024)">mastery properties</span> of two kinds of weapons of your choice with which you have proficiency, such as [Daggers](compendium/items/dagger-xphb.md) and [Shortbows](compendium/items/shortbow-xphb.md).
...
If a Cunning Strike effect requires a saving throw, the DC equals 8 plus your Dexterity modifier and [Proficiency Bonus](rules/variant-rules/proficiency-xphb.md).
...
Once you use this feature, you can't use it again until you finish a [Short](rules/variant-rules/short-rest-xphb.md) or [Long Rest](rules/variant-rules/long-rest-xphb.md).